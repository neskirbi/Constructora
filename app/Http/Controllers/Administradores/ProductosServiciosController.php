...
class ProductosServiciosController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('administradores.productosyservicios.index', compact('productos', 'search'));
    }
    ...
    {
        return view('administradores.productosyservicios.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('administradores.productosyservicios.show', compact('producto'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('administradores.productosyservicios.edit', compact('producto'));
    }
