...
<body>
                ...
                <div class="container-fluid py-4">
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    <form method="GET" action="{{ route('acompras.index') }}">
                                        <div class="input-group">
                                            ...
                                            @if($search)
                                            <a href="{{ route('acompras.index') }}" class="btn btn-secondary">
                                ...
                                <div class="compra-card">
                                    ...
                                    <div class="compra-footer">
                                        ...
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('acompras.show', $compra->id) }}" 
                            ...
                            @else
                                <div class="empty-state">
                                    ...
                                    @if($search)
                                    <a href="{{ route('acompras.index') }}" class="btn btn-outline-primary">
                                        <i class="fas fa-list me-1"></i> Ver todas las compras
                                    </a>
                                    @endif
                                </div>
                            @endif
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>¿Estás seguro de que deseas eliminar la compra <strong id="compraNombre"></strong>?</p>
    ...
    <script>
        function confirmDelete(id, nombre) {
            document.getElementById('compraNombre').textContent = nombre;
            
            const form = document.getElementById('deleteForm');
            form.action = '{{ route("acompras.destroy", "") }}/' + id;
