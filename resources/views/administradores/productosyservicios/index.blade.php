                ...
                <div class="container-fluid py-4">
                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    <form method="GET" action="{{ route('aproductosyservicios.index') }}" class="input-group">
                                        <input type="text" 
                                               name="search" 
                                               class="form-control" 
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="text-center py-5">
                                        ...
                                        @if($search)
                                        <a href="{{ route('aproductosyservicios.index') }}" class="btn btn-outline-primary">
                                            <i class="fas fa-list me-1"></i> Ver todos
                                        </a>
                                        @else
                                        <a href="{{ route('aproductosyservicios.create') }}" class="btn btn-primary">
