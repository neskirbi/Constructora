...
<body>
                        ...
                        <div class="card-body">
                            <form action="{{ route('destajos.update', $destajo->id) }}" method="POST" id="destajoForm">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            @enderror
                                            <small class="text-muted">Número secuencial del destajo (no editable)</small>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   id="clave_concepto" 
                                                   name="clave_concepto" 
                                                   value="{{ old('clave_concepto', $destajo->clave_concepto) }}"
                                                   maxlength="50"
                                                   required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select form-select-sm @error('unidad_concepto') is-invalid @enderror" 
                                                ...
                                                @foreach($unidades as $unidad)
                                                    <option value="{{ $unidad }}" {{ old('unidad_concepto', $destajo->unidad_concepto) == $unidad ? 'selected' : '' }}>
                                                        {{ $unidad }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" 
                                                   ...
                                                   id="cantidad" 
                                                   name="cantidad" 
                                                   value="{{ old('cantidad', $destajo->cantidad) }}"
                                                   step="0.01"
                                                   min="0.01"
                                                   required>
                                            @error('cantidad')
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control form-control-sm @error('descripcion_concepto') is-invalid @enderror" 
                                                      ...
                                                      rows="3"
                                                      maxlength="500"
                                                      required>{{ old('descripcion_concepto', $destajo->descripcion_concepto) }}</textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="number" 
                                                       ...
                                                       value="{{ old('costo_unitario_concepto', $destajo->costo_unitario_concepto) }}"
                                                       step="0.01"
                                                       min="0"
                                                       required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <input type="number" 
                                                       ...
                                                       id="iva" 
                                                       name="iva" 
                                                       value="{{ old('iva', $destajo->iva ? ($destajo->iva / $destajo->costo_operado * 100) : 16) }}"
                                                       step="0.01"
                                                       min="0">
                                                <span class="input-group-text">%</span>
                                                @error('iva')
                                            ...
                                            <div class="card-body p-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 text-end">
                                                        <p class="mb-1 small" id="subtotal">${{ number_format($destajo->costo_operado, 2) }}</p>
                                                        <p class="mb-1 small" id="ivaCalculado">${{ number_format($destajo->iva, 2) }}</p>
                                                        <p class="mb-0 small fw-bold" id="totalCalculado">${{ number_format($destajo->total, 2) }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="verificado" class="form-label">Estado</label>
                                            <select class="form-select form-select-sm @error('verificado') is-invalid @enderror" 
                                                    id="verificado" 
                                                    name="verificado">
                                                <option value="1" {{ old('verificado', $destajo->verificado ?? 1) == 1 ? 'selected' : '' }}>Pendiente</option>
                                                <option value="2" {{ old('verificado', $destajo->verificado ?? 1) == 2 ? 'selected' : '' }}>Aprobado</option>
                                                <option value="0" {{ old('verificado', $destajo->verificado ?? 1) == 0 ? 'selected' : '' }}>Rechazado</option>
                                            </select>
                                            @error('verificado')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Calcular al cargar si hay cambios
            calcularTotales();
