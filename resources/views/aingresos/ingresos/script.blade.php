...
// Función para actualizar información del contrato
...
// Función para cargar contrato y sus datos (AJAX)
function cargarDatosContrato(contratoId, urlUltimoIngreso, callback) {
    if (!contratoId) {
    ...
    $.ajax({
        url: urlUltimoIngreso + '/' + contratoId,
        type: 'GET',
        dataType: 'json',
